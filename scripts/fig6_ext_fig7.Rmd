...
ggsave('output_figures/Figure_6.svg', fig5, dpi = 300, 
...
supp_7 <- shared_module_plot + free(num_shared_plot) + free(shared_net_plot) +
  plot_layout(ncol = 1,
              heights = c(4, 1),
              widths = c(1, 3),
              design = des) +
...
ggsave('output_figures/Supplementary_Figure_7.svg', supp_7, dpi = 300,
       units = 'mm', height = 185, width = 180)

ggsave('output_figures/Supplementary_Figure_7.png', supp_7, dpi = 300,
       units = 'mm', height = 185, width = 180)
```
