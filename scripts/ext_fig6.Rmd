...
aa_dram <- read_xlsx("data/metabolism_summary.xlsx", 
...
def <- read_csv("data/new_def/definitions_C_N_S_P_11_14_24.csv") %>% 
  filter(Category_2 == 'Phosphate and amino acid transporters') 

annotations <- read_tsv("data/annotations_merged.tsv")

geTMM <- read_csv("data/geTMM_normalized_matrix_2024.csv")
...
ext_fig6 <- annot_completeness_plot + annot_AA_plot + trans_AA_plot +
  plot_layout(ncol = 1, heights = c(1.5, 1.5, 1)) +
  plot_annotation(tag_levels = 'A')

# ext_fig6

ggsave('updated_figures/ext_figure6.svg', ext_fig6, dpi = 300, 
